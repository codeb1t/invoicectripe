...
<html>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
							...
							<input type="text" class="form-control" id="input-amount" placeholder="10 $">
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
							...
							<input type="text" class="form-control" id="input-company" placeholder="Получатель">
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(".button-generate").click(function() {
            ...
            $.post("generator.php", { "amount": amount.val(),"company": company.val(), "worker": worker.val() })
